...
export const AppSidebar = memo(({ user, onHistoryClick, isProUser }: AppSidebarProps) => {
  ...
  return (
    <Sidebar
      collapsible="icon"
      className="shitou-sidebar shadow-none! border-none! **:data-[slot=sidebar-gap]:bg-transparent"
    >
      {/* Header */}
          ...
          <SidebarMenuItem>
            <div className="relative flex items-center w-full h-12 px-2 overflow-visible">
              ...
              >
                ...
                >
                  <div className="flex size-8 items-center justify-center border border-[#d7bd7b]/65 bg-[#111f28] text-[#d7bd7b] transition-opacity duration-200 group-data-[collapsible=icon]:group-hover:opacity-0">
                  ...
                  <div className="flex flex-row items-center gap-2 leading-none group-data-[collapsible=icon]:hidden">
                    <span className="font-serif text-xl text-[#f4eedf]">石头学术</span>
                  </div>
                </Link>
              </Button>
        ...
        <SidebarMenu className="gap-1">
          <SidebarMenuItem>
            <SidebarMenuButton
              asChild
              tooltip="论文搜索"
              className={cn('shitou-nav-item', (pathname === '/' || pathname === '/scholar') && 'shitou-nav-active')}
            >
              <Link
                href="/scholar"
                onClick={closeMobileSidebar}
              ...
              >
                <Search size={18} />
                <span className="group-data-[collapsible=icon]:hidden">论文搜索</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton
              asChild
              tooltip="AI 研究助手"
              className={cn('shitou-nav-item', pathname === '/assistant' && 'shitou-nav-active')}
            >
              <Link
                href="/assistant"
                onClick={closeMobileSidebar}
              ...
              >
                <Sparkles size={18} />
                <span className="group-data-[collapsible=icon]:hidden">AI 研究助手</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
          {user && (
            <>
              <SidebarMenuItem>
                <SidebarMenuButton
                  asChild
                  tooltip="论文下载"
                  className={cn('shitou-nav-item', pathname === '/downloads' && 'shitou-nav-active')}
                >
                  <Link
                    href="/downloads"
                    onClick={closeMobileSidebar}
                  ...
                  >
                    <Download size={18} />
                    <span className="group-data-[collapsible=icon]:hidden">论文下载</span>
                  </Link>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                <SidebarMenuButton
                  asChild
                  tooltip="科研绘图"
                  className={cn('shitou-nav-item', pathname === '/figures' && 'shitou-nav-active')}
                >
                  <Link
                    href="/figures"
                    onClick={closeMobileSidebar}
                  ...
                  >
                    ...
                    <span className="group-data-[collapsible=icon]:hidden">科研绘图</span>
                  </Link>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                <SidebarMenuButton
                  asChild
                  tooltip="账户设置"
                  className={cn('shitou-nav-item', pathname === '/settings' && 'shitou-nav-active')}
                >
                  <Link
                    href="/settings"
                    onClick={closeMobileSidebar}
                  ...
                  >
                    <GearIcon size={18} />
                    <span className="group-data-[collapsible=icon]:hidden">账户设置</span>
                  </Link>
                </SidebarMenuButton>
              </SidebarMenuItem>
            </>
          ...
          <SidebarMenu className="gap-0">
            <SidebarMenuItem>
              <a
                ...
                rel="noreferrer"
                onClick={closeMobileSidebar}
                className="flex items-center gap-2 border-b border-sidebar-border/70 px-3 py-3 text-xs text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-foreground"
              >
                <WalletCards className="h-4 w-4 shrink-0 text-[#002FA7]" />
                <span className="truncate group-data-[collapsible=icon]:hidden">余额由 yf-mail.com 同步</span>
              </a>
            </SidebarMenuItem>
            <SidebarMenuItem>
