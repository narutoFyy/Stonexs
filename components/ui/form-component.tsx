            ...
            >
              {isRecording ? (
                ...
                <Textarea
                  ...
                  className={cn(
                    ...
                    // Keep the native input transparent while the stable research prompt is visible.
              ...
              {!isRecording && !input && !isEnhancing && !isTypewriting && !hasInteracted && (
                <div className="absolute top-0 left-0 right-0 pointer-events-none z-10 px-4 py-[14px]">
                  <span className="text-[16px] leading-normal text-muted-foreground/90 font-sans">
                    搜索论文、作者或 DOI
                  </span>
                </div>
              )}
