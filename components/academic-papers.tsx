      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <a href={paper.url} target="_blank" rel="noopener noreferrer" className="flex min-w-0 flex-1 items-center gap-1.5">
              ...
              <div key={searchIndex} className="border-b border-border/30 last:border-0">
                ...
                <div className="divide-y divide-border/20">
                  {search.results.map((paper, resultIndex) => (
                    <AcademicSourceCard key={resultIndex} paper={paper} />
                  ))}
                </div>
              </div>
            ))}
          ...
          <div className="border-t border-border/40">
            ...
            <div className="max-h-80 overflow-y-auto divide-y divide-border/20">
              {allResults.map((paper, index) => (
                <AcademicSourceCard key={index} paper={paper} />
              ))}
            </div>
          </div>
        )}
